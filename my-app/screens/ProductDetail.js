      ...
      <ScrollView>
        <View style={{ margin: 50 }}>
          ...
          <View style={[styles.boxFrame, { marginBottom: 30 }]}>
            ...
            <Text style={[styles.regText, { margin: 5 }]}>
              Final price: {currentProduct.price + currentProduct.shippingPrice}
              $
            </Text>
          </View>
          ...
          >
            ...
            <Text style={[styles.regText, { marginTop: 10 }]}>
              {currentProduct.reviews.calcGrade()} / 5
            </Text>
          </View>
          ...
          <View style={[styles.AddToCart, { flexDirection: "row" }]}>
            ...
            >
              <Text style={[styles.AddToCartText, { marginBottom: 5 }]}>
                Add to cart -{">"}{" "}
              </Text>
